...
export async function getPOIsWithinRadius(
  ...
  return filtered.map((poi) => ({
    poi: {
      ...
      facebook_url: (poi as Record<string, unknown>).facebook_url ?? null,
      google_phone: (poi as Record<string, unknown>).google_phone ?? null,
      opening_hours_json: (poi as Record<string, unknown>).opening_hours_json ?? null,
      opening_hours_updated_at: (poi as Record<string, unknown>).opening_hours_updated_at ?? null,
      ...
      source: (poi as Record<string, unknown>).source ?? null,
...
export async function getProjectContainerFromSupabase(
  ...
  return {
    ...
    welcomeTitle: (projectAny.welcome_title as string | null) ?? undefined,
