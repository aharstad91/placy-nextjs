...
const answeredFaqIdsProperty = { type: "array", items: { type: "string" }, maxItems: 4, description: "Katalogspørsmål svaret dekker (ID)." };
...
export const nyhavnaMapTools: RealtimeTool[] = [
  {
    ...
    parameters: schema({
      ...
      answered_faq_ids: answeredFaqIdsProperty,
    }, ["poi_ids"]),
  },
  {
  ...
  },
  {
    ...
    parameters: schema({ category_id: { type: "string" }, answered_faq_ids: answeredFaqIdsProperty }, ["category_id"]),
  },
  {
