...
await db.exec(await readFile(new URL('../../../supabase/migrations/093_voice_metering.sql',import.meta.url),'utf8'));
await db.exec(await readFile(new URL('../../../supabase/migrations/094_voice_close_lease.sql',import.meta.url),'utf8'));
