...
export async function verifySharedPlatform(db, race) {
  const migration = await readFile(new URL('../../../supabase/migrations/097_shared_voice_platform.sql', import.meta.url), 'utf8');
  ...
  for (const name of ['095_voice_metering.sql', '096_voice_close_lease.sql']) {
