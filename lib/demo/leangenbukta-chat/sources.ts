...
/**
 * Kilderegisteret tekstchatten viser kilder fra (2026-09-24).
 *
 * Samme fil som datasettet (`data/demo/leangenbukta-lokal/sources.json`) — det
 * er den ENESTE lista over kilder et svar kan vise. En kilde-ID er bare bevis
 * når den (1) står i et verktøysvar fra DENNE meldingen og (2) finnes her.
 * En ID modellen skriver selv, eller en registerkilde verktøyene ikke
 * returnerte, blir aldri vist.
 *
