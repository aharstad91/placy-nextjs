...
import { X, Bookmark, Loader2, Copy, Check, ExternalLink } from "lucide-react";
...
export default function CollectionDrawer({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center md:justify-end">
      ...
      {/* Drawer */}
      <div className="relative w-full md:w-[400px] md:h-full bg-white md:shadow-xl animate-slide-up md:animate-none flex flex-col max-h-[85vh] md:max-h-full rounded-t-2xl md:rounded-none">
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 flex-shrink-0">
          ...
          <button
            onClick={view === "list" ? onClose : handleFinish}
