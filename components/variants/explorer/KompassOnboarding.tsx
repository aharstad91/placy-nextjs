...
interface KompassOnboardingProps {
...
export default function KompassOnboarding({
  themes,
  eventDays,
  dayLabels,
  ...
  const skipKompass = useKompassStore((s) => s.skipKompass);
  ...
  const canProceed = useMemo(() => {
    switch (step) {
      ...
      case 2:
        return true; // Day is optional (null = hele festivalen)
      case 3:
        return true; // Time slots optional
    }
  }, [step, selectedThemes]);

  const handleNext = useCallback(() => {
    if (step === 3) {
      // If no time slots selected, treat as "hele dagen"
      completeKompass();
    } else {
      nextStep();
    }
      ...
      <div className="relative w-full lg:w-[440px] lg:rounded-2xl bg-white rounded-t-2xl shadow-2xl animate-slide-up max-h-[85vh] flex flex-col">
        ...
        <div className="flex-shrink-0 px-6 pt-5 pb-3">
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            <h2 className="text-lg font-bold text-gray-900">Kompass</h2>
          </div>
        ...
        {/* Footer */}
        <div className="flex-shrink-0 px-6 pb-6 pt-3 border-t border-gray-100">
