...
export default function TripPreview({
  ...
  return (
    <main className="min-h-screen bg-[#FAF8F5]">
      ...
      {/* Rewards teaser */}
      {rewardTitle && (
        <div className="mx-5 sm:mx-8 mb-6 p-5 bg-amber-50 border border-amber-200 rounded-2xl flex items-start gap-4">
      ...
      <div className={`flex-1 pb-4 ${isLast ? "" : "border-b border-stone-100"}`}>
        <div className="flex gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {description && (
              <p className="text-sm text-[#5a5042] mt-1.5 line-clamp-2 leading-relaxed">
                {description}
              </p>
            )}
          </div>
