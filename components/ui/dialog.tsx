    ...
    <DialogPortal>
      <DialogOverlay className="flex items-center justify-center">
        <DialogPrimitive.Content
          ...
          className={cn(
            "relative z-50 grid w-full max-w-[calc(100%-2rem)] gap-6 rounded-2xl bg-popover p-6 text-sm text-popover-foreground shadow-xl ring-1 ring-foreground/5 outline-none sm:max-w-md",
            className
          )}
          {...props}
        >
