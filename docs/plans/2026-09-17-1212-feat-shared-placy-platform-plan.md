...
**Dependencies:** None.
**Files:** `supabase/migrations/095_shared_voice_platform.sql`, `lib/live/metering/types.ts`, `lib/supabase/types.ts`, `lib/live/metering/shared-platform.test.ts`, `scripts/verify-voice-platform.ts`.
...
- `supabase/migrations/093_voice_metering.sql`, `094_voice_close_lease.sql`: atomic per-tenant reservation and finalization.
