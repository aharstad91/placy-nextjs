...
Slett `app/demo/leangenbukta-nettside/`, `app/demo/leangenbukta-tilgang/`, `app/api/demo/leangenbukta-chat/`, `data/demo/leangenbukta-nettside/`, `public/demo/leangenbukta-nettside/`, `lib/demo/leangenbukta-chat/profile.ts` og proxy-grenen for `/demo/leangenbukta-*`. Fra 24.09 bruker Nyhavna-kopiens chat de øvrige modulene i `lib/demo/leangenbukta-chat/` (svarløkke, token, kilder, tale), `lib/demo/leangenbukta-site/usage.ts`, `public/embed/placy-chat.js` og talebroen; de skal stå så lenge Nyhavna-chatten finnes. Tilgangsmodulen `lib/demo/leangenbukta-site/access.ts` og Leangenbukta-grenene i Live-rutene kan fjernes sammen med `lib/live/leangenbukta-voice-access.ts` når `lib/live/demo-voice-access.ts` rettes. Boardet og produksjonsdataene er ikke avhengige av noe av dette.
