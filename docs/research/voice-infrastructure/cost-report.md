...
Verification: `npx vitest run lib/live/cost-report.test.ts`, targeted ESLint and TypeScript. Tests cover arithmetic, incomplete exclusion, empty/unknown data, separate cohorts, capability exclusion, 1001 sessions/events with capped pagination, filter/cutoff forwarding, denied reads and CSV escaping. Live grant denial and real-conversation reconciliation require the integrated migrated ledger and are release evidence still to collect.
