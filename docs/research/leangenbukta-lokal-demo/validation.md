...
| Desktop | Åtte temaer, 26 unike kartankre, kategori, kartpunkt, detalj og FAQ | Bestått |
...
| Reisetid | Gange, sykkel og bil viser målte Mapbox-tider for de 26 ankrene | Bestått |
...
- `npm test`: 283 testfiler og 4 489 tester bestått.
