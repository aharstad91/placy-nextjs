...
SET config = jsonb_set(
  jsonb_set(config,
    ...
    '"Brøset Hageby holdeplass er rett utenfor — linje 12 og 113 gir direkteavganger mot Strindheimsentrum og Dragvoll. [Trondheim Bysykkel](https://trondheimbysykkel.no) har to stasjoner innen gangavstand: Valentinlyst og Kong Øysteins veg dekker begge retninger langs Valentinlystveien. Sparkesykler fra [Ryde](https://ryde.io), [VOI](https://www.voi.com) og [Dott](https://ridedott.com) er spredt i nabolaget for korte, fleksible hopp."'::jsonb
  ),
